                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="mb-2"><strong>Tipe:</strong><br>{{ $purchaseOrder->supplier->type_display }}</p>
                                <p class="mb-2"><strong>Contact Person:</strong><br>{{ $purchaseOrder->supplier->contact_person }}</p>
                            </div>
                            <div class="col-md-6">
                                ...
                                <p class="mb-2"><strong>Alamat:</strong><br>{{ $purchaseOrder->supplier->full_address }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tfoot class="table-light">
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-end"><strong>Pajak ({{ setting('tax_rate', 11) }}%):</strong></td>
                                        <td class="text-end"><strong>Rp {{ number_format($purchaseOrder->tax_amount, 0, ',', '.') }}</strong></td>
                                    </tr>
                                    <tr class="table-success">
                                        <td colspan="4" class="text-end"><h5 class="mb-0">TOTAL:</h5></td>
                                        <td class="text-end">
                                            <h5 class="mb-0 text-success">Rp {{ number_format($purchaseOrder->total_amount, 0, ',', '.') }}</h5>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
            ...
            <form action="{{ route('owner.purchase-orders.approve', $purchaseOrder) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center my-3">
                        <h3 class="text-success">Rp {{ number_format($purchaseOrder->total_amount, 0, ',', '.') }}</h3>
                    </div>
                    ...
                    <p class="mb-0 text-muted">
                        <small>
                            <i class='bx bx-info-circle'></i>
                            Setelah approve, admin akan melakukan pemesanan ke supplier dan melakukan receive stock saat barang tiba.
                        </small>
                    </p>
                </div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('owner.purchase-orders.reject', $purchaseOrder) }}" method="POST" id="rejectForm">
                @csrf
                <div class="modal-body">
                    <div class="alert alert-danger">
                    ...
                    <p class="mb-0 text-muted">
                        <small>
                            <i class='bx bx-info-circle'></i>
                            Admin akan menerima email notifikasi berisi alasan penolakan dan dapat mengedit PO untuk submit ulang.
                        </small>
                    </p>
                </div>
                <div class="modal-footer">
