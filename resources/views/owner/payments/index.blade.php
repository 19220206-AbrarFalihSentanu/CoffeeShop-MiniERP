{{-- File: resources/views/owner/payments/index.blade.php --}}
{{-- SAMA seperti admin/payments/index.blade.php, hanya beda route --}}
    ...
    <div class="card mb-3">
        <div class="card-body py-2">
            <form method="GET" class="row g-2 align-items-center">
                ...
                <div class="col-auto">
                    <a href="{{ route('owner.payments.index') }}" class="btn btn-sm btn-secondary">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    <thead>
                        <tr>
                            <th>{{ __('payments.payment_number') }}</th>
                            <th>Customer</th>
                            <th>Jumlah</th>
                            <th>Metode</th>
                            <th>Upload Pada</th>
                    ...
                    <tbody>
                        @forelse($payments as $payment)
                            <tr>
                                <td>
                                    <a href="{{ route('owner.payments.show', $payment) }}" class="fw-bold text-primary">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('owner.payments.show', $payment) }}" class="btn btn-sm btn-primary">
