                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('owner.products.show', $product) }}">
                                                <i class="bx bx-show me-1"></i> Lihat
                                            </a>
                                            <a class="dropdown-item" href="{{ route('owner.products.edit', $product) }}">
                                                <i class="bx bx-edit me-1"></i> Edit
                                            </a>
                                            <form action="{{ route('owner.products.toggleFeatured', $product) }}"
                                                method="POST">
                                                @csrf
