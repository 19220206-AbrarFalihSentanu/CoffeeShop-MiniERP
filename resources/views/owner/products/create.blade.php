                ...
                <div class="card-body">
                    <form action="{{ route('owner.products.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        placeholder="Contoh: Arabica Gayo Premium" required autofocus>
                                    @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror" id="type"
                                                ...
                                                <option value="ground" {{ old('type') == 'ground' ? 'selected' : '' }}>
                                                    Ground (Bubuk)
                                                </option>
                                                <option value="instant" {{ old('type') == 'instant' ? 'selected' : '' }}>
                                                    Instant
                                                </option>
                                            </select>
                                            @error('type')
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Jelaskan karakteristik, aroma, rasa, dan keunggulan
                                        produk</small>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('weight') is-invalid @enderror"
                                                id="weight" name="weight" value="{{ old('weight', 1000) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            @error('unit')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Satuan untuk penjualan (kg/gram/ton)</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('min_order_qty', 1) }}" placeholder="1" step="0.001"
                                                min="0.001" required>
                                            @error('min_order_qty')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                placeholder="45000" step="0.01" min="0" required>
                                            @error('cost_price')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('order_increment', 0.5) }}" placeholder="0.5"
                                                step="0.001" min="0.001">
                                            @error('order_increment')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Order harus kelipatan nilai ini (misal: 0.5
                                                kg)</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="price" value="{{ old('price') }}" placeholder="85000"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="image-preview mb-2" id="imagePreview"
                                        ...
                                        <div class="image-preview-placeholder">
                                            ...
                                            <p class="mb-0 small text-muted">JPG, PNG, WEBP</p>
                                            <p class="mb-0 small text-muted">Max 2MB</p>
                                        </div>
                                    </div>
                                    <input type="file"
                                    ...
                                    @enderror
                                    <small class="text-muted">Gambar utama produk (opsional)</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="discount-section" id="discountSection"
                            style="display: {{ old('has_discount') ? 'block' : 'none' }}">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="discount_type" class="form-label">
                                            Tipe Diskon <span class="text-danger" id="discount_required">*</span>
                                        </label>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="discount_value" class="form-label">
                                            ...
                                            <span class="text-danger" id="discount_value_required">*</span>
                                        </label>
                                        <div class="input-group">
                                            <input type="number"
                                                class="form-control @error('discount_value') is-invalid @enderror"
                                                id="discount_value" name="discount_value"
                                                value="{{ old('discount_value') }}" placeholder="0" step="0.01"
                                                min="0">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('discount_start_date', date('Y-m-d')) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('discount_end_date') }}" min="{{ date('Y-m-d') }}">
                            ...
                            <div class="alert alert-warning mb-0">
                                ...
                                <strong>Catatan:</strong> Diskon akan ditampilkan di katalog produk dan customer dapat
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('initial_stock')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Jumlah stok produk saat pertama kali ditambahkan</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('min_stock')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Sistem akan memberikan peringatan jika stok mencapai angka
                                        ini</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label" for="is_featured">
                                            ...
                                            <br>
                                            <small class="text-muted">Tampilkan di halaman utama sebagai produk
                                                unggulan</small>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-info mb-0">
                                    <i class="bx bx-info-circle me-1"></i>
                                    <small>SKU akan di-generate otomatis oleh sistem</small>
                                </div>
                            </div>
                        </div>
