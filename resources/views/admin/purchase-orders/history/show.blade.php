{{-- File: resources/views/admin/purchase-orders/history/show.blade.php --}}
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('admin.purchase-orders.history.index') }}">{{ __('purchase_orders.po_history') }}</a>
            </li>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <div class="text-end">
                            <a href="{{ route('admin.purchase-orders.history.index') }}" class="btn btn-secondary btn-sm">
