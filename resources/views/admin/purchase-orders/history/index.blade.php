{{-- File: resources/views/admin/purchase-orders/history/index.blade.php --}}
        ...
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('admin.purchase-orders.history.index') }}" class="btn btn-secondary">
                        ...
                        @forelse($purchaseOrders as $po)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.purchase-orders.history.show', $po) }}"
