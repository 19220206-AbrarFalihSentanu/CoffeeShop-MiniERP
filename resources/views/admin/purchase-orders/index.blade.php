                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="search" class="form-control"
                            placeholder="Cari nomor PO atau supplier..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-2">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if ($po->status === 'draft')
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.purchase-orders.edit', $po) }}">
                                                    <i class='bx bx-edit me-1'></i> Edit
                                                </a>
                                                <form action="{{ route('admin.purchase-orders.submit', $po) }}"
                                                    method="POST" data-confirm="PO akan dikirim ke Owner untuk approval."
                                            ...
                                            @if ($po->canDelete())
                                                <form action="{{ route('admin.purchase-orders.destroy', $po) }}"
                                                    method="POST" data-confirm="PO akan dihapus permanen."
                                                    data-confirm-title="Hapus PO?" data-confirm-icon="warning"
