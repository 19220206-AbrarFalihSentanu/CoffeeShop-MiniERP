{{-- File: resources/views/admin/orders/history/show.blade.php --}}
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('admin.orders.history.index') }}">{{ __('orders.order_history') }}</a>
            </li>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a href="{{ route('admin.orders.history.index') }}" class="btn btn-outline-secondary w-100">
