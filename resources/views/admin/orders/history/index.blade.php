{{-- File: resources/views/admin/orders/history/index.blade.php --}}
        ...
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('admin.orders.history.index') }}" class="btn btn-secondary">
                        ...
                        @forelse($orders as $order)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.orders.history.show', $order) }}"
