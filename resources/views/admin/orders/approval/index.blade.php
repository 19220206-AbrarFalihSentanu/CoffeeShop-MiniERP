{{-- File: resources/views/admin/orders/approval/index.blade.php --}}
    ...
    <div class="card mb-3">
        <div class="card-body py-2">
            <form method="GET" class="row g-2 align-items-center">
                ...
                <div class="col-auto">
                    <a href="{{ route('admin.orders.approval.index') }}" class="btn btn-sm btn-secondary">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                        ...
                        <a href="{{ route('admin.orders.approval.show', $order) }}" class="btn btn-primary btn-sm">
