                            ...
                            <form action="{{ route('admin.orders.approval.approve', $order) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    <label for="shipping_cost" class="form-label">
                                        <i class="bx bx-truck me-1"></i>Ongkir (Opsional)
                                    </label>
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('shipping_cost', number_format($order->shipping_cost, 0)) }}"
                                    ...
                                    @enderror
                                    <small class="text-muted">
                                        <i class="bx bx-info-circle me-1"></i>Kosongkan untuk menggunakan ongkir default
                                        (Rp {{ number_format(setting('shipping_cost', 0), 0, ',', '.') }})
                                    </small>
                                </div>
