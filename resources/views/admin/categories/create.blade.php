                ...
                <form action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                            ...
                            placeholder="Contoh: Arabica" required autofocus>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                            ...
                            placeholder="Contoh: bx-coffee">
                        @error('icon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Gunakan class dari <a href="https://boxicons.com/" target="_blank">Boxicons</a>. Contoh: bx-coffee, bx-coffee-togo</small>
                    </div>
