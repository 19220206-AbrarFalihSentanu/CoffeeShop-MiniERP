<?php
// File: app/Http/Controllers/Admin/OrderHistoryController.php
...
class OrderHistoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.orders.history.index', compact('orders', 'stats'));
    }
    ...
    public function show(Order $order)
    {
        ...
        return view('admin.orders.history.show', compact('order'));
    }
}
