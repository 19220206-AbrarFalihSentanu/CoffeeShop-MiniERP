<?php
// File: app/Http/Controllers/Owner/PurchaseOrderHistoryController.php
...
class PurchaseOrderHistoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('owner.purchase-orders.history.index', compact('purchaseOrders', 'stats'));
    }
    ...
    public function show(PurchaseOrder $purchaseOrder)
    {
        ...
        return view('owner.purchase-orders.history.show', compact('purchaseOrder'));
    }
}
