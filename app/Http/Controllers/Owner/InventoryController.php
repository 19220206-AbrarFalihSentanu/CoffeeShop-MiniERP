<?php
// File: app/Http/Controllers/Owner/InventoryController.php
// Jalankan: php artisan make:controller Owner/InventoryController
...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('owner.inventory.index', compact('products', 'categories', 'stats'));
    }
    ...
    public function adjust(Product $product)
    {
        ...
        return view('owner.inventory.adjust', compact('product'));
    }
    ...
    public function logs(Request $request)
    {
        ...
        return view('owner.inventory.logs', compact('logs', 'products'));
    }
    ...
    public function bulkAdjust()
    {
        ...
        return view('owner.inventory.bulk-adjust', compact('products'));
    }
    ...
    public function alerts()
    {
        ...
        return view('owner.inventory.alerts', compact('lowStockProducts', 'outOfStockProducts'));
    }
}
